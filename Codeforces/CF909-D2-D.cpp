...
/*
	...
	@problem: http://codeforces.com/contest/909/problem/D
	@link: Colorful Points
	@judge: Codeforces
	@idea: do simulation on consecutive groups of the same color instead of single points
*/
